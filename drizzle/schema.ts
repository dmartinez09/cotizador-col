...
export const users = mysqlTable("users", {
  ...
  passwordHash: varchar("passwordHash", { length: 255 }), // bcrypt/scrypt hash — null for OAuth-only users
...
export const pdfDocuments = mysqlTable("pdfDocuments", {
  ...
  blobUrl: text("blobUrl"),           // Azure Blob URL or null if local
  blobKey: varchar("blobKey", { length: 500 }), // Azure Blob path
